                            ...
                            <form class="form-validate form-horizontal" method="post" action="<?php echo site_url('a_pengetahuan/tambahPengetahuan')?>">
                                ...
                                <label for="pertanyaan" class="control-label col-lg-2">Pertanyaan</label>
                                    <div class="col-lg-10">
										...
										<option value=""></option>
										<?php foreach ($data_gejala as $k) {
											echo "<option value='Apakah ikan mengalami $k->nama_gejala ?'>$k->kd_gejala - Apakah ikan mengalami $k->nama_gejala ?</option>";
										} ?>
                                ...
                                <label for="nama_gejala" class="control-label col-lg-2">Nilai mb</label>
									<div class="col-lg-10">
										<input type="number" class="form-control" required step="0.01" name="mb" id="">
									</div>
								</div>
								<div class="form-group">
                                <label for="nama_gejala" class="control-label col-lg-2">Nilai md</label>
									<div class="col-lg-10">
										<input type="number" class="form-control" step="0.01" required name="md" id="">
									</div>
                                </div>
                                <div class="form-group">
