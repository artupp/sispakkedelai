                            ...
                            <form class="form-validate form-horizontal" method="post" action="<?php echo site_url('a_pengetahuan/edit')?>">
                                ...
                                <label for="nama_gejala" class="control-label col-lg-2">Pertanyaan</label>
                                    <div class="col-lg-10">
										...
										<option value="Apakah ikan mengalami <?php echo $baris['pertanyaan'] ?> ?">Apakah Air mengalami <?php echo $baris['pertanyaan'] ?> ?</option>
										<?php foreach ($data_gejala as $k) {
											echo "<option value='Apakah ikan mengalami $k->nama_gejala ?'>Apakah ikan mengalami $k->nama_gejala ?</option>";
										} ?>
								...
								<div class="form-group">
                                <label for="nama_gejala" class="control-label col-lg-2">Nilai mb</label>
									<div class="col-lg-10">
										<input type="number" class="form-control" required step="0.01" value="<?=$baris['Mb']?>" name="mb" id="">
									</div>
								</div>
								<div class="form-group">
                                <label for="nama_gejala" class="control-label col-lg-2">Nilai md</label>
									<div class="col-lg-10">
										<input type="number" class="form-control" step="0.01" required value="<?=$baris['Md']?>" name="md" id="">
									</div>
                                </div>
                                <div class="form-group">
